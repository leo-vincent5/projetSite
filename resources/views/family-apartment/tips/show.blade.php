...
<div class="min-h-screen bg-stone-50 text-stone-800 pb-32">
    ...
    {{-- HEADER --}}
    <header class="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-xl flex items-center justify-between px-6 h-16 border-b">
    ...
    <main class="pt-20 max-w-5xl mx-auto px-4 md:px-8">
        ...
        {{-- IMAGE HERO --}}
        <section class="mb-10">
            <div class="relative w-full h-[350px] rounded-xl overflow-hidden shadow-lg">

                @if($tip->image_url)
                    <img src="{{ $tip->image_url }}" class="w-full h-full object-cover">
                @else
                ...
                <div class="absolute top-4 left-4">
                    <span class="bg-emerald-100 text-emerald-700 px-4 py-1 rounded-full text-sm font-bold">
                        {{ $tip->category_label }}
                    </span>
                </div>
            </div>
        ...
        <section class="mb-10">
            <div class="flex flex-col md:flex-row md:items-end justify-between gap-6">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="flex items-center gap-2">
                            <div class="w-8 h-8 rounded-full bg-emerald-100 flex items-center justify-center text-xs font-bold">
                                {{ $tip->author_initial }}
                            </div>
                ...
                @if($tip->lat && $tip->lng)
                <a
                    href="https://www.google.com/maps?q={{ $tip->lat }},{{ $tip->lng }}"
                    target="_blank"
