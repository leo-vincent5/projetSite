{{-- resources/views/family-apartment/bookings/create.blade.php --}}
@extends('layouts.app')
...
<div class="min-h-screen bg-stone-50 text-stone-800 pb-32">
    ...
    <main class="mx-auto max-w-3xl px-6 pt-28">
        ...
        <div class="mb-10">
            ...
            <p class="mt-2 text-lg text-stone-500">
                Planifiez les prochains passages de la famille dans l’appartement.
            </p>
        </div>
        ...
        <form action="{{ route('family-apartment.bookings.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                <section class="rounded-3xl border border-stone-200 bg-white p-6 shadow-sm">
                    <label for="start_date" class="mb-4 flex items-center gap-2 text-sm font-bold uppercase tracking-widest text-emerald-700">
                        <span>📅</span>
                        <span>Arrivée</span>
                    </label>
                ...
                <section class="rounded-3xl border border-stone-200 bg-white p-6 shadow-sm">
                    <label for="end_date" class="mb-4 flex items-center gap-2 text-sm font-bold uppercase tracking-widest text-emerald-700">
                        <span>🧳</span>
                        <span>Départ</span>
                    </label>
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                <section class="rounded-3xl border border-stone-200 bg-white p-6 shadow-sm">
                    <label for="status" class="mb-4 block text-sm font-bold uppercase tracking-widest text-emerald-700">
                        Statut
                    </label>
                ...
                <section class="rounded-3xl border border-stone-200 bg-white p-6 shadow-sm">
                    <label for="guests_count" class="mb-4 block text-sm font-bold uppercase tracking-widest text-emerald-700">
                        Nombre de personnes
                    </label>
            ...
            <section class="rounded-3xl bg-stone-100 p-8">
                <label for="description" class="mb-4 block text-sm font-bold uppercase tracking-widest text-emerald-700">
                    Description
                </label>
                ...
                <textarea
                    ...
                    class="w-full rounded-2xl border-0 bg-white px-5 py-4 text-stone-800 placeholder:text-stone-400 focus:ring-2 focus:ring-emerald-300"
            ...
            <section class="relative overflow-hidden rounded-3xl bg-amber-100/70 p-8">
                ...
                <label for="practical_info" class="mb-4 block text-sm font-bold uppercase tracking-widest text-amber-800">
                    Infos pratiques
                </label>
            ...
            {{-- NOTE MÉNAGE / RAPPEL --}}
            <section class="rounded-3xl border border-stone-200 bg-white p-8 shadow-sm">
                <label for="reminder_note" class="mb-4 block text-sm font-bold uppercase tracking-widest text-emerald-700">
                    Pense-bête
                </label>
                ...
                <textarea
                    ...
                    class="w-full rounded-2xl border-0 bg-stone-100 px-5 py-4 text-stone-800 placeholder:text-stone-400 focus:ring-2 focus:ring-emerald-300"
                >{{ old('reminder_note') }}</textarea>
            </section>
            ...
            <div class="flex flex-col gap-3 pt-2 sm:flex-row sm:justify-end">
                ...
                >
                    <span>✓</span>
                    <span>Enregistrer le séjour</span>
                </button>
            </div>
        </form>
    </main>
    ...
    <nav class="fixed inset-x-0 bottom-0 z-50 border-t border-stone-200 bg-white/95 backdrop-blur xl:hidden">
        <div class="mx-auto flex max-w-xl items-center justify-around px-4 py-3">
            <a href="{{ route('family-apartment.dashboard') }}" class="flex flex-col items-center gap-1 text-stone-500">
                <span class="text-lg">⌂</span>
                <span class="text-xs font-medium">Accueil</span>
            </a>

            <a href="{{ route('family-apartment.bookings.create') }}" class="flex flex-col items-center gap-1 text-emerald-700">
                <span class="text-lg">＋</span>
