...
@section('content')
    <div class="min-h-screen bg-stone-50 text-stone-800 pb-32">
        ...
        <main class="mx-auto max-w-3xl px-6 pt-28">
            ...
            <form id="bookingForm" action="{{ route('family-apartment.bookings.store') }}" method="POST" class="space-y-8">
                @csrf
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <section class="rounded-3xl border border-stone-200 bg-white p-6 shadow-sm">
                        ...
                        <input id="guests_count" name="guests_count" type="number" min="1"
                            value="{{ old('guests_count') }}" placeholder="Ex : 2"
                ...
                <section class="rounded-3xl bg-stone-100 p-8">
                    ...
                    <textarea id="description" name="description" rows="5"
                        ...
                        class="w-full rounded-2xl border-0 bg-white px-5 py-4 text-stone-800 placeholder:text-stone-400 focus:ring-2 focus:ring-emerald-300">{{ old('description') }}</textarea>
                </section>
                ...
                <section class="relative overflow-hidden rounded-3xl bg-amber-100/70 p-8">
                    ...
                    <input id="practical_info" name="practical_info" type="text" value="{{ old('practical_info') }}"
                ...
                <section class="rounded-3xl border border-stone-200 bg-white p-8 shadow-sm">
                    ...
                    <textarea id="reminder_note" name="reminder_note" rows="3"
                        ...
                        class="w-full rounded-2xl border-0 bg-stone-100 px-5 py-4 text-stone-800 placeholder:text-stone-400 focus:ring-2 focus:ring-emerald-300">{{ old('reminder_note') }}</textarea>
                </section>
        ...
        @if (session('conflict'))
            <div id="confirmModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
                <div class="bg-white rounded-3xl p-6 max-w-md w-full shadow-xl">

                    <h3 class="text-xl font-bold mb-4">Conflit de réservation</h3>
                    ...
                    <div class="flex justify-end gap-3">
                        <button onclick="closeModal()" class="px-4 py-2 rounded-full border border-stone-200">
                            Annuler
                        </button>

                        <button onclick="confirmBooking()"
                            class="px-4 py-2 rounded-full bg-emerald-600 text-white font-bold">
...
@push('scripts')
    <script>
        ...
        function confirmBooking() {
            document.getElementById('forceInput').value = '1';
