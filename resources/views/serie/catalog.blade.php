...
@php
    ...
    $series = $series ?? [
        ...
        [
            ...
            'year' => '2023',
            'rating' => '18+',
            'image' => 'https://lh3.googleusercontent.com/aida-public/AB6AXuAT6t8jGPhHXW_8Em3h6oP_EAQri4ZB4OAghNJOKhFuEp3GblcrJbkOJzj_BJn_dUf_Lx5_IgluI6HJKh_1751NfmlTmR-8LTmspspdN5AvZlGvh5tqDlDJvL134GdxVKN-2DyGh2QZOoBtkyk-rk_a369japOZXwnYI2w2E8egdMafBNLxo9kiqcf536_zMqNn25yhgkSWyxDS3t2D8pI7aiitMErLxpkdw8got1qyGoR1Aasj-DcPBeiZa09O_VQYpnooXT-j110',
        ],
        [
            'title' => 'SILENT ORBIT',
            'match' => '89% MATCH',
            'year' => '2024',
            'rating' => 'TV-14',
            'image' => 'https://lh3.googleusercontent.com/aida-public/AB6AXuAeLhlNHEmgr1XngwwhOv7vTDt4B5PRdojv8uBixIeqDHSjiIg3Kn_hJCR9J8FIbINcxoJyx9F6ss80PLJN4VcKv8R2e7ARiJuZ9rn8UyfamLLC_ZgKzJY3y8FD0SXXoF9ohD_OHsB3fE7bmmZEAUivjjuj5b6bxXSIGlE7qC5fPvK6aSDSSJXtgjN6f2SZWU6jAp9VyVt7RMOdc-rg5i8gRKTqLpyq9K0x8hBI1-f51a44JKa-qByRm3ow3tmq-4opBWiUU879r2U',
        ],
        [
            'title' => 'MIND FRAME',
            'match' => '99% MATCH',
            'year' => '2024',
            'rating' => 'TV-MA',
            'image' => 'https://lh3.googleusercontent.com/aida-public/AB6AXuAEQPY6bPh5ZXBwfIfLshwJmSbm3thllTX0wB2vE_4xSulsYi5VSXNqYloOHFa73pLvnxjJXbaeUGVeYmcigRyNfeKW5QLywKQQoGtbuUiGamlEjJ_NhM7TQKL5H0WhsyDwpNn1ddR-GHn9_PFi500tlZIH1B9duwPFHp0vrpKDhhR_JbyKnwjITw6f7obgn-f9eC5V5HFyEAB8aXA9Pt5drOJW_Emd6b4TXbPmRxciFi0zPhZBdXHv1j29bp_ZRYzrxB6yPrVyrWk',
        ],
        [
            'title' => 'DUNE STRAND',
            'match' => '82% MATCH',
            'year' => '2022',
            'rating' => 'TV-PG',
            'image' => 'https://lh3.googleusercontent.com/aida-public/AB6AXuD7NaCB2nU34BjSFfzKUc8ZQnC91CgBHUfnExoGRzkBmDKAkifSdBNMPKlsgNw0wguQWQTz4DGOqTLDAP5cicFa1kbyEhT_HJevTd90naPMqZ3WEz2LSMvK1eoDpO_dIxZVupnMTMeRCgzRgslFe4bM2xzDmzjYpLdEtcj5pcWpDCyDS4yKGvP0PX8wMv1Nqh0tV4ZO3SSR_7Z3EpUesFCWM6GFJzqsffhpsGQ7ulJ_XTcwY8fJb99SLs8TsEO6ktZhiYpW-5fkhBA',
        ],
        [
            'title' => 'NIGHT DRIFT',
            'match' => '91% MATCH',
        ...
        [
            ...
            'year' => '2023',
            'rating' => 'TV-14',
            'image' => 'https://lh3.googleusercontent.com/aida-public/AB6AXuBJyeNvBr35QHt0k6sTwqbigxo989cH04lIp_QfzD7Lkb5mRRej98M3t2RwgvS5iBnF2BQihaSxuJgIprhxy096BDRadxDWaTkai_05We_roeZXZytsmKKqvTmDEyOd0Xzr3OxwoRISI1vLOIbrFRLh8GMCz7KaYMKEopWzVL2wDjQHuaBLF0EUzrbpgSSgblwZVL8m2i_TiacgL-QOfyOrG5fe22NWWliiO3rLgSkptL3uozS0Y4HOWjFHLGfYKFbe_b_C6J4uqQE',
        ],
        [
            'title' => 'THE FOUNDRY',
            'match' => '95% MATCH',
        ...
        [
            ...
            'year' => '2023',
            'rating' => 'TV-G',
            'image' => 'https://lh3.googleusercontent.com/aida-public/AB6AXuDFlKdBAiV7kjQWXImtpTHldJlT2SOwaGEdJmcpYCmEvdvPbmlIFcZN4LyUyaU3g6tOBREEnFGGGPBZwaFjArovL_9SsqmZRXU6Om1IbMmqsk77ZFsjob2Ini-KFysLK7XLCE33-_Caap7AkknoFZ5gL6bhZJGpHF6VVvNufXRErBPzDMBAUDtQfSjwl4y2IFq89544TP9TCFsYWPUo2-WF91W6WIbpAh3Qr--OrRp_gL1eQG1zGmIHRxfDGIY-C-IOyoRkmpGbw5E',
        ],
        [
            'title' => 'STARRY ECHO',
            'match' => '92% MATCH',
            'year' => '2024',
            'rating' => 'TV-14',
            'image' => 'https://lh3.googleusercontent.com/aida-public/AB6AXuDLL7mzYjxYCKlUVo-OjgNXcKfB3wbyyHt5VcFpOVw_0APc3buXBq1X1SFM8oPRGBemFjNfFFIH8G9abd4AXjdqRgUx9tQWtsH58TjyqKgu0oqfsNMwADFcBbA7Qqrq5x0b6_46qrM7Y6AWcdd69f5gQC-f4FZLt1VYSzyO_6h9mZtxMHDF3BVf5tuoV2LcR9FfSoWeYd5gPyhPLz-yaKj9PhONEgzFLXfj1j2awFx5JZ4lV5UF_ODzh-zGQnNLqytFKWXDRwKxtVM',
        ],
    ];
@endphp
...
<body class="bg-[#0e0e0e] text-white selection:bg-fuchsia-400/30">
    ...
    <header class="fixed top-0 left-0 z-50 flex w-full items-center justify-between bg-[#0e0e0e]/60 px-8 py-6 shadow-[0_12px_40px_rgba(0,0,0,0.5)] backdrop-blur-xl">
        <div class="flex items-center gap-4">
            <button type="button" class="text-[#e08dff] transition-transform transition-colors duration-300 active:scale-95 hover:text-white">
                <span class="material-symbols-outlined">menu</span>
            </button>

            <h1 class="font-headline text-2xl font-bold uppercase tracking-[0.2em] text-transparent bg-gradient-to-br from-[#e08dff] to-[#d978ff] bg-clip-text">
                Knockturn Alley
            </h1>
        </div>
    ...
    <div class="group relative w-full">
        ...
        <input
            ...
            placeholder="Rechercher une série, un réalisateur..."
            autocomplete="off"
        ...
        <div class="flex items-center gap-6">
            <div class="hidden items-center gap-8 text-sm font-semibold uppercase tracking-widest md:flex">
                <a href="{{ route('aloserie') }}" class="text-[#adaaaa] transition-colors duration-300 hover:text-white">Home</a>
    ...
    <main class="mx-auto min-h-screen max-w-[1600px] px-6 pb-32 pt-32 md:px-12">
        <section class="mb-12">
            ...
            <p class="max-w-xl text-lg font-light leading-relaxed text-[#adaaaa]">
                Explore notre sélection de séries et créations originales. Chaque affiche peut mener vers ta fiche série ou ton lecteur.
            </p>
        </section>
...
<form method="GET" action="{{ url()->current() }}" class="sticky top-[88px] z-40 -mx-6 mb-8 bg-[#0e0e0e]/80 px-6 py-4 backdrop-blur-md">
    <div class="flex flex-col gap-4">
        ...
        <div class="flex flex-wrap gap-3">
            @foreach ($filters as $filter)
                ...
                <label class="cursor-pointer">
                    ...
                    ">
                        <span class="h-2 w-2 rounded-full {{ $isActive ? 'bg-fuchsia-950' : 'bg-[#6b6b6b]' }}"></span>
                        {{ $filterName }}
                    </span>
                </label>
            @endforeach
        ...
        <div class="grid grid-cols-2 gap-x-6 gap-y-10 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
            @foreach ($series as $item)
                <a href="{{ route('oneserie', ['id' => $item['id']]) }}" class="group block cursor-pointer">
                    <div class="relative mb-4 aspect-[2/3] overflow-hidden rounded-2xl bg-[#1a1a1a] transition-transform duration-500 group-hover:scale-[1.03]">
                        <img
                        ...
                        @if (!empty($item['badge']))
                            <div class="absolute left-3 top-3 rounded-sm bg-fuchsia-400/90 px-2 py-1 text-[10px] font-bold uppercase tracking-tight text-fuchsia-950">
                                {{ $item['badge'] }}
                            </div>
                        @endif
                    </div>
                    ...
                    <div class="space-y-1">
                        <h3 class="font-headline text-lg font-bold tracking-tight text-white transition-colors group-hover:text-fuchsia-300">
                            {{ $item['title'] }}
                        </h3>
        ...
        <div class="mt-20 flex justify-center">
            <button type="button" class="group flex items-center gap-4 text-[#adaaaa] transition-colors duration-300 hover:text-white">
    ...
    <nav class="fixed bottom-0 left-0 z-50 flex w-full items-center justify-around rounded-t-[2rem] bg-[#0e0e0e]/80 px-6 pb-8 pt-4 shadow-[0_-8px_32px_rgba(0,0,0,0.8)] backdrop-blur-2xl">
        <a href="{{ route('aloserie') }}" class="flex flex-col items-center justify-center text-[#adaaaa] opacity-60 transition-opacity duration-200 hover:opacity-100 active:scale-90">
            <span class="material-symbols-outlined mb-1">home</span>
            <span class="text-[10px] font-semibold uppercase tracking-[0.1em]">Home</span>
        </a>

        <a href="#" class="flex flex-col items-center justify-center text-[#adaaaa] opacity-60 transition-opacity duration-200 hover:opacity-100 active:scale-90">
            <span class="material-symbols-outlined mb-1">movie_filter</span>
            <span class="text-[10px] font-semibold uppercase tracking-[0.1em]">Originals</span>
        </a>

        <a href="#" class="flex flex-col items-center justify-center text-[#e08dff] active:scale-90">
            <span class="material-symbols-outlined mb-1">grid_view</span>
            <span class="text-[10px] font-semibold uppercase tracking-[0.1em]">Catalog</span>
            <span class="mt-1 h-1 w-1 rounded-full bg-[#e08dff]"></span>
        </a>

        <a href="#" class="flex flex-col items-center justify-center text-[#adaaaa] opacity-60 transition-opacity duration-200 hover:opacity-100 active:scale-90">
            <span class="material-symbols-outlined mb-1">bookmarks</span>
            <span class="text-[10px] font-semibold uppercase tracking-[0.1em]">List</span>
        </a>

        <a href="#" class="flex flex-col items-center justify-center text-[#adaaaa] opacity-60 transition-opacity duration-200 hover:opacity-100 active:scale-90">
            <span class="material-symbols-outlined mb-1">person</span>
            <span class="text-[10px] font-semibold uppercase tracking-[0.1em]">Profile</span>
        </a>
    </nav>
...
<div id="searchModal" class="fixed inset-0 z-[200] hidden">
    ...
    <div class="relative z-[201] flex min-h-screen items-start justify-center px-4 pt-[10vh] pb-6">
        <div class="w-full max-w-4xl overflow-hidden rounded-3xl border border-white/10 bg-[#111111]/95 shadow-2xl">
