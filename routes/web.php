...
// Route pour ajouter une note à un appel
    ...
    Route::prefix('bons-plans')->name('tips.')->group(function () {
    Route::get('/', [FamilyApartmentTipController::class, 'index'])->name('index');
    Route::get('/create', [FamilyApartmentTipController::class, 'create'])->name('create');
    Route::post('/store', [FamilyApartmentTipController::class, 'store'])->name('store');
    Route::get('/{tip}', [FamilyApartmentTipController::class, 'show'])->name('show');
});
